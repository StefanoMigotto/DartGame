...
namespace FreccetteNuovo
{
    ...
    {
        public CalculationProcess(string[] args)
        {
            /*
        ...
        public static void StartGame(bool mode)
        {
            ...
            int TypeOfRace = AnsiConsole.Ask<int>("Seleziona il tipo di gara (1: FITA (12) 2: INDOOR 18 M (10) 3: HUNTER/FIELD (24)");

            switch (TypeOfRace)
            {
                case 1: Fita fita = new Fita(); break;
                case 2: Indoor indoor = new Indoor(); break;
                case 3: HunterEField hunterEField = new HunterEField(); break;
            }
